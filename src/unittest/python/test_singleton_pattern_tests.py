...
class MyTestCase(unittest.TestCase):
    ...
    def test_cancellation_store_singleton(self):
        """testing singleton for CancellationJsonStore"""
        vm1 = CancellationJsonStore()
        vm2 = CancellationJsonStore()
        vm3 = CancellationJsonStore()
        vm4 = CancellationJsonStore()
