...
class VaccinationAppointment():
    ...
    def __init__( self, patient_sys_id, patient_phone_number, patient_date):
        self.__alg = "SHA-256"
        self.__type = "DS"
        self.__appointment_date = Date(patient_date).value
        ...
        self.__appointment_state = "Not cancelled"
    ...
    def appointment_date(self, value):
        self.__appointment_date = Date(value).value
