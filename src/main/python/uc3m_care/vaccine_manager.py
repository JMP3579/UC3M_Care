...
from uc3m_care.data.vaccination_appointment_cancel import VaccinationAppointmentCancel
...
class VaccineManager:
    ...
    class __VaccineManager:
        ...
        def cancel_appointment(self, input_file):
            ...
            my_appointment = VaccinationAppointmentCancel.create_appointment_cancelation_request_from_json_file(input_file)
