...
class CancelationJsonParser(JsonParser):
    """Subclass of JsonParer for parsing inputs of cancel_appointment"""
    BAD_DATE_SIGNATURE_ERROR = "Bad label date_signature"
    BAD_CANCELATION_TYPE_ERROR = "Bad label cancelation_type"
    BAD_REASON_ERROR = "Bad label reason"
    ...
    _ERROR_MESSAGES = [BAD_DATE_SIGNATURE_ERROR, BAD_CANCELATION_TYPE_ERROR, BAD_REASON_ERROR]
